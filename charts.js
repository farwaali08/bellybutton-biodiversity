  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: "This chart displays the count and type of <br>      each bacterial species (OTU's) for each subject.",
        showarrow: false
      }]   
    };
...
//Bubble chart
    ...
    var bubbleLayout = {
      ...
      annotations: [{
        ...
        y: 1,
        yanchor: 'center',
        text: "This chart displays the number of <br> bacterial cultures per sample.",
        font: "Helvetica",
        showarrow: false
      }]
    };
  ...
  var wfreq= parseInt(meta1.wfreq);
    ...
    var gaugeLayout = {
      ...
      annotations: [{
        ...
        y: 0,
        yanchor: 'center',
        text: "This chart displays the subject's belly-button <br> washing frequency.",
        showarrow: false,
        font: "Helvetica"
      }]
    };
